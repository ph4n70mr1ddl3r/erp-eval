...
| **Frequency** | ~2,000–3,000 non-PO invoices/month across all locations (200 stores + 4 DCs + HQ); combined with ~6,500 merchandise/vendor invoices (W7), total AP invoice volume is ~8,500–9,500/month; the ~6,000–7,000 figure in the model-company-profile §10.2 refers to merchandise/vendor invoices only |
...
| **Volume** | ~6,510 fixed assets across all entities (POS terminals, forklifts, vehicles, fixtures, IT servers, office equipment) |
