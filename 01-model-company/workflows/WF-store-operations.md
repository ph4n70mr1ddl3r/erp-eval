...
- [W5A. Store Opening](#store-opening)
- [W5B. In-Store Selling](#in-store-selling)
- [W5D. In-Store Customer Delivery Scheduling](#in-store-customer-delivery-scheduling)
- [W5E. Store Opening Delay Procedure](#store-opening-delay-procedure)
- [W5F. Store Closing & End-of-Day](#store-closing--end-of-day)
- [W5G. Offline POS Recovery & Reconciliation](#offline-pos-recovery-reconciliation)
- [W12. Returns & Exchanges](#returns-exchanges)
- [W12A. In-Store Returns](#in-store-returns)
- [W12B. Online-Initiated Returns](#online-initiated-returns)
- [W12C. Cross-Store Returns (Purchased at Store A, Returned at Store B)](#cross-store-returns-purchased-at-store-a-returned-at-store-b)
...
- [W18B. DSD Vendor Delivery Scheduling](#dsd-vendor-delivery-scheduling)
